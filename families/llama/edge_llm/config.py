...
"""Explicit Llama paired-build inputs; no shared execution-mode contract."""
...
class BuildExecutionInputs:
    ...
    Llama validates these inputs without fetching or inferring companions.
    """
...
@dataclass(frozen=True)
class LlamaBuildRequest(BuildRequest):
...
def with_execution(request: BuildRequest, execution: BuildExecutionInputs) -> LlamaBuildRequest:
