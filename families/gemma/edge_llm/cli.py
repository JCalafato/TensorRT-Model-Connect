...
"""Gemma-owned CLI options for explicit paired Edge execution."""
...
def add_build_arguments(parser: argparse.ArgumentParser) -> None:
    """Register options only when the Gemma family has been resolved."""
    parser.add_argument("--execution-variant", choices=("mtp", "dspark"),
                        help="Explicit Gemma paired execution mode")
