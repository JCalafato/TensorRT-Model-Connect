...
```sh
trtmc qwen3_5 build /path/to/target --precision fp16 \
  --execution-variant dflash --companion draft=/path/to/draft \
  -o model.bundle
```

Options may precede or follow MODEL. `trtmc qwen3_5 build /path/to/target --help`
