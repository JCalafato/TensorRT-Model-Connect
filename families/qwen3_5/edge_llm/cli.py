...
"""Qwen35-owned CLI options for explicit paired Edge execution."""
...
def add_build_arguments(parser: argparse.ArgumentParser) -> None:
    """Register options only when the Qwen35 family has been resolved."""
    parser.add_argument("--execution-variant", choices=("dflash",),
                        help="Explicit Qwen35 paired execution mode")
