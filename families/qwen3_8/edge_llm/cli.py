...
"""Qwen38-owned CLI options for explicit paired Edge execution."""
...
def add_build_arguments(parser: argparse.ArgumentParser) -> None:
    """Register options only when the Qwen38 family has been resolved."""
    parser.add_argument("--execution-variant", choices=("dspark",),
                        help="Explicit Qwen38 paired execution mode")
